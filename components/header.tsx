    ...
    <header className="sticky top-0 z-50 border-b border-black/5 bg-[#f7f4ee]/90 backdrop-blur-xl">
      <div className="container-shop flex h-20 items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link href="/wishlist" aria-label="Wishlist" className="hidden rounded-full p-3 hover:bg-white md:block"><Heart size={18} /></Link>
          <Link href="/account" aria-label="Account" className="hidden rounded-full p-3 hover:bg-white md:block"><UserRound size={18} /></Link>
